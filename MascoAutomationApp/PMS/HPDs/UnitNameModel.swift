...
struct UnitNameResponse: Codable {
    var error: String = ""
    var _listUnitName : [UnitName]
    ...
    enum CodingKeys: String, CodingKey {
     ...
     init(from decoder: Decoder) throws {
            ...
            self._listUnitName = try container.decodeIfPresent([UnitName].self, forKey: ._listUnitName) ?? []
        }
